...
torch::Tensor evaluate_flexible_MLP(
	torch::Tensor& positions, const torch::Tensor& direction, const torch::Tensor& bias, const torch::Tensor& hiddenStructure, const int batchsize, const int featuresize, const int outputdim0, const int outputdim2)
{
