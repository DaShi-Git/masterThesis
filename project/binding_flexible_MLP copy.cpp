...
printf("test float value is %f", test[0][0]);
  ...
  //}
	...
	bool success = RENDERER_DISPATCH_FLOATING_TYPES(scalarType, "evaluate", [&]()
      ...
      // const auto accDirection = direction;
			...
			const void *args[] = {&texObj, &accTest, &accWeights, &accInput, &accBias, &accOutput, &batchsizeTotal, &featuresize};
