...
// i saved this on 26.08, 这一版很重要，通过添加__syncthreads(); 和#pragma unroll 实现了计算准确
//#include <vector>
...
__global__ void EvaluateMLPFlexible(
  cudaTextureObject_t texObj, kernel::Tensor2Read<real_t> test, kernel::Tensor2RW<real_t> weights, kernel::Tensor2RW<real_t> input, kernel::Tensor2RW<real_t> bias, kernel::Tensor2RW<real_t> output, int batchsizeTotal, int featuresize) {
